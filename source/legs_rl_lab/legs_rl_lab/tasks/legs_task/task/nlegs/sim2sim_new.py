"""Run an exported nlegs policy in MuJoCo. Training parameters come only from deploy.yaml."""
...
RUN = "2026-08-25_20-27-40"
LOGS_ROOT = os.path.join(_REPO_ROOT, "logs", "rsl_rl", "nlegs")
SCENE_XML = os.path.join(
    _REPO_ROOT, "source", "legs_rl_lab", "legs_rl_lab", "assets", "legs_narrow", "mjcf",
    "legs_narrow_scene.xml",
)
ZERO_OFFSET = {}
