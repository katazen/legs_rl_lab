...
from .nlegs_env_cfg import RobotEnvCfg, RobotPlayEnvCfg
...
@configclass
class RobotStaticEnvCfg(RobotEnvCfg):
...
@configclass
class RobotStaticPlayEnvCfg(RobotPlayEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        _apply_static(self)
