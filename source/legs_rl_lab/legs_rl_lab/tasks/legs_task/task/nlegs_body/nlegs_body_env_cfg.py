...
from legs_rl_lab.assets.nlegs.nlegs_body import NLEGS_BODY_CFG
...
class RobotSceneCfg(InteractiveSceneCfg):
    ...
    robot: ArticulationCfg = NLEGS_BODY_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
...
class EventCfg:
    ...
    randomize_ankle_gains = EventTerm(
        ...
        params={
            ...
            "stiffness_distribution_params": (0.6, 1.0),
            "damping_distribution_params": (1.0, 1.8),
            "operation": "scale",
...
class RewardsCfg:
    ...
    # 新 root 比已验证 nlegs 的 root 低 0.122 m：0.58 - 0.122 = 0.458。
    base_height = RewTerm(func=mdp.base_height_l2, weight=-5, params={"target_height": 0.458})
    ...
    feet_y_distance = RewTerm(
        ...
        weight=-2.0,
        params={"threshold": 0.2655, "asset_cfg": SceneEntityCfg("robot", body_names=".*6")},
    )
